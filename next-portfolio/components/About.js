...
const Aboutt = () => {
    return (
    <div id="about"> 
        <div className='p-5 text-white z-[2] bg-[#ffffff] '>
            <div class="py-16 ">  
                <div class="container bg-[#aec8d85a] p-5 m-auto px-6 text-gray-600 md:px-12 xl:px-6">
                <h2 class="text-5xl text-center tracking-wide uppercase text-[#373333f1] mb-5 lg:mt-20 " >Hello! I'm Alex, </h2>
                <h2 className='text-3xl text-center tracking-wide uppercase text-[#08377c] mb-10 '>a passionate and versatile software engineer.</h2>
                    <div class="space-y-6 md:space-y-0 md:flex justify-center md:gap-6 lg:items-center lg:gap-12">
                        ...
                        <div class="md:7/12 lg:w-5/12">
                            ...
                            <p class="mt-6 text-[#000000] md:text-xl">Born and raised in beautiful Italy, I later pursued my undergraduate degree in the United States, where I honed my skills and developed a deep passion for technology. My international background has equipped me with valuable skills and has taught me how to quickly adapt to new environments, embrace different perspectives, and work effectively with individuals from various backgrounds.  .</p>

                            <p class="mt-6 text-[#000000] md:text-xl">I am a collaborative team player who thrives in an environment that fosters creativity and encourages continuous growth. One of my greatest strengths is my ability to learn new technologies and concepts rapidly. </p>
